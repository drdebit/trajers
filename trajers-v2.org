...
** Simulation Implementation
  ...
  This appendix provides the complete implementation of the agent-based simulation described in Section 3, written in Clojure, a functional programming language whose immutable data structures and first-class functions make it well suited to modeling stateless agent interactions. The code serves two purposes: it provides a concrete, executable specification of the model, and it enables replication and extension of the results.
