...
** [#A] cite:hongDisagreementStockMarket2007a have a model that is somewhat similar where they allow investors to observe only one of two signals and trade with one another. 
